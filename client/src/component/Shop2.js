...
const Home = () => {
  ...
  useEffect(() => {
    axios.get("http://localhost:8001/getusersShop2")
      .then((res) => {
  ...
  //   const getdata = async () => {
  //     try {
  //       const res = await fetch("/getusersShop2", {
  //         method: "GET",
  //         headers: {
    ...
    <>
      ...
      <div className="mt-5">
        <div className="container">
          ...
          <NavLink to="/Shop2Register" className="btn btn-primary mb-3 ">
              Add data
          </NavLink>
              ...
              return (
                <tr key={index}>
                  ...
                  <td className="d-flex justify-content-between">
                    <NavLink to={`Shop2view/${getUserdata.id}`}>
                      <button className="btn btn-success">
                        <VisibilityIcon />
                      </button>
                    </NavLink>
                    <NavLink to={`Shop2edit/${getUserdata.id}`}>
                      {" "}
